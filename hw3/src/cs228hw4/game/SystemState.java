...
public interface SystemState {
	...
	/**
	 * Retrieve the states of all neighbors reachable via wormhole from this system.
	 * Systems out of scanning range but a neighbor of one that is within range will
	 * appear as a null entry.
	 * 
	...
	/**
	 * Array of costs to get from this system to the corresponding system returned
	 * by getNeighbors(). If the neighbor is not scanned, cost to that system will
	 * be 0 (as you did not scan this cost).
	 * 
