...
/**
 * Represents a directed graph with edge costs. Vertices cannot be null. Do not
 * alter the structure of the graph while iterating, or the behavior is not
 * well-defined. Similarly, behavior is undefined if the objects of type V that
 * comprise the set of vertices of this graph are mutable and are changed after
 * being added to the graph. All methods run in constant time.
 * 
 * @author Justin Mason
 *
